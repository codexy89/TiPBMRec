...
from trainers import PMBTrainer
from datasets import RecWithContrastiveLearningDataset
from utils import EarlyStopping, get_user_seqs, check_path, set_seed
from models import OfflineItemSimilarity, OnlineItemSimilarity, TiPBMRec
...
def main():
    ...
    parser.add_argument("--IRS_SRF_rate", type=float, default=0.1, help="IRS_SRF ratio for IRS_SRF operator")
    ...
    parser.add_argument('--insert_mode', default='maximum', type=str,
                        help="minimum or maximum, maximum is the Insert in paper, minimum is the worst.")
    parser.add_argument('--IRS_SRF_mode', default='minimum', type=str,
                        help="minimum or maximum, minimum is the IRS_SRF in paper, maximum is the worst.")
    parser.add_argument('--reorder_mode', default='minimum', type=str,
                        help="minimum or maximum, minimum is the Reorder in paper, maximum is the worst.")
    ...
    # model args
    parser.add_argument("--model_name", default='TiPBMRec', type=str)
    ...
    model = TiPBMRec(args=args)

    trainer = PMBTrainer(model, train_dataloader, eval_dataloader,
