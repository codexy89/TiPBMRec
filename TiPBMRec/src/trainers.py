...
from utils.data import DataLoader, RandomSampler
...
class Trainer:
    ...
    def get_sample_scores(self, epoch, pred_list):
        ...
        HIT_1, NDCG_1, MRR, HR_1 = get_metric(pred_list, 1)
        HIT_5, NDCG_5, MRR, HR_5 = get_metric(pred_list, 5)
        HIT_10, NDCG_10, MRR, HR_10 = get_metric(pred_list, 10)
        post_fix = {
            "Epoch": epoch,
...
class PMBTrainer(Trainer):
    ...
    def __init__(self, model,
                 ...
                 test_dataloader,
                 args):
        super(PMBTrainer, self).__init__(
            model,
            train_dataloader,
            eval_dataloader,
            test_dataloader,
